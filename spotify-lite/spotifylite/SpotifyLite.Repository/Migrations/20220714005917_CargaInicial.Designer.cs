...
namespace SpotifyLite.Repository.Migrations
{
    ...
    [Migration("20220714005917_CargaInicial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SpotifyLite.Domain.Album.Song", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SpotifyLite.Domain.User.UserFavoriteSong", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SpotifyLite.Domain.User.UserFavoriteSong", b =>
                {
                    b.HasOne("SpotifyLite.Domain.Album.Song", "Song")
                        .WithMany()
                        .HasForeignKey("SongId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
